...
```text
Evidence: <specific symptom and decisive supplied or observed clues>
Contenders: <2–5 specific hypotheses; mark falsified or surviving>
Discriminator: <cheapest check that best separates survivors + result>
Localization: <file/function/config + supporting evidence>
```
